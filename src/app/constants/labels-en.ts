export const LABELS_EN = {
  ...
  ABOUT: {
    ...
    WHY_TEXT:
      'We were exhausted by generic guides and crowded tourist traps. We missed the thrill of stumbling upon a place with real soul. A cozy corner café. A vibrant local secret. So we built a way to bring back the magic of discovery. Connecting you instantly to the heartbeat of your city.',
  ...
  PRIVACY: {
    ...
    CONTACT: 'Contact Us',
    CONTACT_TEXT:
      'If you have any questions about this Privacy Policy, please contact us at privacy@whtsnyr.me.',
  },
  COMMON: {
